  ...
  return (
    <main className="min-h-screen flex flex-col">
      ...
      <div className="flex justify-center items-center gap-8 py-6 fixed bottom-2 w-full">
        <button
          onClick={prev}
          className="flex items-center gap-2 px-5 py-2 border border-gray-300 hover:bg-gray-100 transition-colors rounded-l-xl bg-white/70  backdrop-blur-md"
        >
        ...
        <button
          onClick={next}
          className="flex items-center gap-2 px-5 py-2 border border-gray-300 hover:bg-gray-100 transition-colors rounded-r-xl bg-white/70  backdrop-blur-md"
        >
